...
function HeroSection() {
  return (
    <div className="h-96 relative w-full overflow-hidden bg-slate-900 flex flex-col items-center">
      ...
      <div className="relative z-20 mt-10 ">
        <button className="flex items-center justify-center text-lg font-semibold gap-2 w-30 h-10 hover:scale-110 cursor-pointer ease-in-out duration-150 bg-amber-500 rounded-lg">
